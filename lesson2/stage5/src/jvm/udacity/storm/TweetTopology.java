...
public class TweetTopology {
  ...
  static class ReportBolt extends BaseRichBolt
  {
        ...
        OutputCollector         outputCollector)
    {
      ...
      RedisClient client = new RedisClient("172.17.0.6",6379);
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    TweetSpout tweetSpout = new TweetSpout(
        ...
        //"[Your access token]",
        //"[Your access secret]"
      "Zk4dc789quFk2W7yDFglQOcF7",
      "6Dx6qHQdebjryhNkSOLI7lsupxEzxRGN3485vi9LbhYhiBgFhJ",
      "3405523227-NT8axmXEV1Gf1oViBMGJXtSNIlBXkA0dvxycgpA",
      "NNpu85l4xD53nw4wZgcLtlm4k1azYbVPwy3IKwzbkBLYE"
    );
